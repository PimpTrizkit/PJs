...
Note: None of these functions (files) are meant to be linked in separately. They are to be copied and pasted into the `head` of your HTML on a "as desired" basis. Also, I have used all of these in various situations and feel good about their performance. But, I have not fully added all practical features yet, nor testing in all relevant situations.
